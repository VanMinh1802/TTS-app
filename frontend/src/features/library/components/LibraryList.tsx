    ...
    <div className="aether-glass-wrapper rounded-[24px] mt-4 overflow-x-auto">
      <div className="aether-glass rounded-[24px] overflow-hidden">
        <div className="flex items-center gap-4 px-6 py-4 border-b border-white/[0.06]">
          ...
          <div className="shrink-0 w-28 text-right text-[10px] font-bold uppercase tracking-[0.15em] text-[#818CF8]">{t.library.colVoice}</div>
          <div className="shrink-0 w-14 text-center text-[10px] font-bold uppercase tracking-[0.15em] text-[#818CF8]">T.gian</div>
          <div className="shrink-0 w-24 text-right text-[10px] font-bold uppercase tracking-[0.15em] text-[#818CF8]">{t.library.colDate}</div>
          <div className="shrink-0 w-24 text-right text-[10px] font-bold uppercase tracking-[0.15em] text-[#818CF8]">{t.library.colStatus}</div>

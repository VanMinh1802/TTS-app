...
function LoginForm() {
  ...
  return (
    <div className="min-h-[calc(100dvh-4rem)] flex items-center justify-center px-4 relative text-[#F4F4F5] overflow-hidden font-light">
...
export default function LoginPage() {
  ...
  if (!GOOGLE_CLIENT_ID) {
    return (
      <div className="min-h-[calc(100dvh-4rem)] flex items-center justify-center px-4 text-[#F4F4F5] font-light">

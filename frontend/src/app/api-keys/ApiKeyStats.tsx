    ...
    <FadeIn delay={0.1}>
      <div className="aether-glass-wrapper rounded-[24px] mb-8">
        <div className="aether-glass p-6">
          <h2 className="text-[10px] font-medium uppercase tracking-[0.2em] text-[#818CF8] mb-6">{t.apiKeys.usageStats}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 divide-y md:divide-y-0 md:divide-x divide-white/10">
            <div className="text-center md:text-left pt-4 md:pt-0">
              ...
              <p className="text-[10px] uppercase font-bold tracking-widest text-[#A1A1AA]">{t.apiKeys.totalQueries}</p>
            </div>
            <div className="text-center md:text-left pt-4 md:pt-0 md:pl-6">
              ...
              <p className="text-[10px] uppercase font-bold tracking-widest text-[#A1A1AA]">{t.apiKeys.successRate}</p>
            </div>
            <div className="text-center md:text-left pt-4 md:pt-0 md:pl-6">
              <p className="text-4xl md:text-5xl font-bold text-[#818CF8] mb-1">{(stats.characters / 1000).toFixed(1)}K</p>
              <p className="text-[10px] uppercase font-bold tracking-widest text-[#A1A1AA]">{t.apiKeys.charsProcessed}</p>
            </div>
          </div>
        </div>
      </div>

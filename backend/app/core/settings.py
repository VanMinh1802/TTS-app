...
class Settings(BaseSettings):
    ...
    # CORS
    CORS_ORIGINS: str = "http://localhost:3000,http://127.0.0.1:3000,https://type2vibe.online,https://www.type2vibe.online,https://frontend.nguyenvanminh180220.workers.dev"
